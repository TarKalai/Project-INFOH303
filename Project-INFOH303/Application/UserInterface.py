...
def goToUserPage():
    ...
    firstQueryButton.grid(row=1, column=0, columnspan=3, pady=10, padx=10)
    ...
    secondQueryButton.grid(row=2, column=0, columnspan=3, pady=10, padx=10)
    ...
    thirdQueryButton.grid(row=3, column=0, columnspan=3, pady=10, padx=10)
    ...
    fourthQueryButton.grid(row=4, column=0, columnspan=3, pady=10, padx=10)
    ...
    fifthQueryButton.grid(row=5, column=0, columnspan=3, pady=10, padx=10)
    ...
    sixthQueryButton.grid(row=6, column=0, columnspan=3, pady=10, padx=10)
